...
workoutRouter.use(login_required);

workoutRouter.post("/workout", async function (req, res, next) {
  try {
...
workoutRouter.get("/workout/item/:itemId", async function (req, res, next) {
  try {
...
workoutRouter.delete("/workout/item/:itemId", async function (req, res, next) {
  try {
    const { itemId } = req.params;
...
workoutRouter.delete("/workout/items", async function (req, res, next) {
  try {
    const userId = req.currentUserId;
