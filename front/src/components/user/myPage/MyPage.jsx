...
export default function MyPage() {
  ...
  // useState 훅을 통해 myPageOwner 상태를 생성함.
  const [myPageOwner, setMyPageOwner] = useState(null);
  // fetchMyPageOwner 함수가 완료된 이후에만 (isFetchCompleted가 true여야) 컴포넌트가 구현되도록 함.
  ...
  const fetchPorfolioOwner = async (ownerId) => {
    ...
    // fetchMyPageOwner 과정이 끝났으므로, isFetchCompleted를 true로 바꿈.
