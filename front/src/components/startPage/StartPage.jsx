    ...
    <StyledContainer>
        ...
        <FirstSectionRight>
          ...
          >
            <P>
              ...
              음식을 <B>먹기 시작한 시점</B>으로부터
              <br /> 평균적으로 <B style={{ fontSize: "2rem" }}>6시간 </B>정도가
              걸린다고 합니다.{" "}
            </P>
            <FirstSectionSecondContent>
            ...
            <P>
              <B>'오늘도 운동'</B>은 <B style={{ fontSize: "2rem" }}>280개</B>의{" "}
              <B style={{ fontSize: "2rem" }}>운동-칼로리 데이터</B>를 기반으로{" "}
              <br /> 잔여 칼로리를 소모하기 위한 <B>추천 운동</B>들과
              <br /> <B>운동에 따른 권장 시간</B> 정보를 함께 제공해 드립니다.
            </P>
          </FirstSectionContentWrapper>
        </FirstSectionRight>
      </Section>
      ...
      >
        <SecondSectionLeft>
          ...
          >
            <P>
              <B>바쁜 일상</B> 속에서 시간을 만들어 운동하신다면, <br />{" "}
              <B>효율적인 운동 방법</B>이 궁금하지 않으신가요? <br /> <br />
              <B>'오늘도 운동'</B>은 <B style={{ fontSize: "2rem" }}>1,327개</B>
              의 <B style={{ fontSize: "2rem" }}>부위별</B>,
              <br />
              <B style={{ fontSize: "2rem" }}>도구별</B> 운동 데이터를 기반으로
              <br /> <B> 가장 효과적인 운동 방법</B>을 <B>추천</B>해 드립니다!
            </P>
          </SecondSectionContentWrapper>
        </SecondSectionLeft>
        <SecondSectionRight>
      ...
      >
        <ThirdSectionLeft>
          ...
          >
            <P>
              음악을 들으며 운동을 하면, 평소보다{" "}
              <B style={{ fontSize: "2rem" }}>15%</B>정도 <B>더 오래</B> <br />{" "}
              운동을 할 수 있다는 연구결과가 있습니다. <br /> <br />
              <B>'오늘도 운동'</B>은{" "}
              <B style={{ fontSize: "2rem" }}>데이터 분석</B>을 통해 엄선된{" "}
              <br />
              <B style={{ fontSize: "2rem" }}>11,825개</B>의 <B>음악 데이터</B>
              를 기반으로
              <br /> 사용자가 <B>더 즐겁고, 힘들지 않게</B> 운동할 수 <br />{" "}
              <ThirdSpan>
      ...
      >
        ...
        <FourthSectionRight>
          ...
          >
            <P>
              <B style={{ fontSize: "2rem" }}>기록</B>의 중요성에 대한 흥미로운
              연구 결과가 있습니다. <br />
              <br /> 이 연구에서, 목표는 있었지만 기록하지 않았던{" "}
              <B style={{ fontSize: "2rem" }}>13%</B>는 <br /> 목표가 전혀
              없었던 <B>84%</B>보다 <B style={{ fontSize: "2rem" }}>2배</B>{" "}
              이상의 성과를, <br />
              <br /> 명확한 목표와 계획을 세우고 구체적으로 기록한{" "}
              <B style={{ fontSize: "2rem" }}>3%</B>는 <br />
              앞에서의 <B>84%</B>보다 <B style={{ fontSize: "2rem" }}>10배</B>{" "}
              이상의 성과를 얻었다고 합니다. <br />
              <br />
              <B>'오늘도 운동'</B>은 <B>체중</B>과 <B>칼로리</B>를 기록하는{" "}
              <B style={{ fontSize: "2rem" }}>캘린더 기능</B>을 통해
              <br /> 여러분들이 원하는 목표를 향해 <B>꾸준히</B> 나아갈 수
              있도록, <br /> 원하는 목표를 이루는 그 순간까지 <B>항상 함께</B>
              하겠습니다.
            </P>
          </FourthSectionContentWrapper>
        </FourthSectionRight>
